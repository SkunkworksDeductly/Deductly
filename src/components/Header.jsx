...
const Header = () => {
  ...
  return (
    <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-border-light px-4 sm:px-10 py-3">
      <Link to="/" className="flex items-center gap-4">
        <div className="size-8 text-accent-peach">
        ...
        {currentUser && (
          <div className="relative" ref={dropdownRef}>
            <button
              ...
              className="bg-center bg-no-repeat aspect-square bg-cover rounded-full size-10 cursor-pointer hover:ring-2 hover:ring-accent-peach transition-all"
              style={{
