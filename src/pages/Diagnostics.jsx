  ...
  return (
    <div className="py-10">
      <div className="max-w-4xl mx-auto px-4 space-y-8">
        <section className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur p-8">
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-4">LSAT Diagnostic</h1>
          ...
          <div className="grid gap-4 md:grid-cols-3 text-sm text-white/70">
            <div className="rounded-xl border border-white/10 bg-white/5 p-4">
              <p className="text-white font-semibold mb-2">Why take it</p>
              <p>Surface strengths and blind spots so your study plan targets the right mix of skills.</p>
            </div>
            <div className="rounded-xl border border-white/10 bg-white/5 p-4">
              <p className="text-white font-semibold mb-2">What to expect</p>
          ...
          {errorMessage && (
            <div className="mt-6 rounded-lg bg-red-500/15 px-4 py-3 text-sm text-red-300">
              {errorMessage}
            </div>
          )}
          <button
            type="button"
            className="mt-8 inline-flex items-center justify-center rounded-lg bg-matte-red px-6 py-3 font-semibold text-white transition hover:bg-matte-red/90 disabled:cursor-not-allowed disabled:opacity-70"
        ...
        <section className="rounded-2xl border border-white/10 bg-transparent p-6 text-white/70">
          <h2 className="text-xl font-semibold text-white mb-3">PACE TIP</h2>
          <p className="text-sm">
