    ...
    <div>
      ...
      <div className="flex justify-stretch mb-8">
        <div className="flex flex-1 gap-3 flex-wrap px-4 py-3 justify-start">
          <Link to="/drill">
            <button className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 px-5 bg-accent-peach hover:bg-accent-peach/80 text-white text-base font-bold leading-normal tracking-[0.015em] transition-colors">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 px-4">
        <div className="lg:col-span-2 flex flex-col gap-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex items-center gap-4">
                <div className="relative size-24">
                  <svg className="size-full" height="36" viewBox="0 0 36 36" width="36" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <circle className="stroke-current text-accent-peach" cx="18" cy="18" fill="none" r="16" strokeDasharray="75 100" strokeDashoffset="25" strokeLinecap="round" strokeWidth="3"></circle>
                  </svg>
                ...
                <div>
                  ...
                  <div className="flex gap-1">
                    ...
                    <p className="text-accent-mint text-base font-medium leading-normal">+5%</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-2 rounded-xl p-6 bg-white border border-border-light shadow-sm">
              ...
              <div className="flex gap-1">
                ...
                <p className="text-accent-mint text-base font-medium leading-normal">+12</p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="flex flex-col gap-2 rounded-lg p-4 text-center bg-white border border-border-light shadow-sm">
                ...
                <p className="text-accent-mint text-sm">+5%</p>
              </div>
              <div className="flex flex-col gap-2 rounded-lg p-4 text-center bg-white border border-border-light shadow-sm">
                ...
                <p className="text-accent-mint text-sm">+2%</p>
              </div>
              <div className="flex flex-col gap-2 rounded-lg p-4 text-center bg-white border border-border-light shadow-sm">
        ...
        <div className="lg:col-span-1 flex flex-col gap-6">
          {/* Recent Activity */}
          <div className="rounded-xl p-6 bg-white border border-border-light shadow-sm">
          ...
          <div className="rounded-xl p-6 bg-white border border-border-light shadow-sm">
            ...
            <div className="flex items-center gap-4 p-4 rounded-lg bg-accent-peach/20">
              <svg className="w-8 h-8 text-accent-peach flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
